...
//    private val auth: FirebaseAuth,
    private var events: MutableList<Post>
...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            //user data
            Glide.with(context).load(event.userImage).into(postUserPicture)
...
//            postEventByuser.text = event.eventbyuser
            ...
            val time = DateFormat.format("dd/MM/yyyy", cal).toString()
            ...
            val onItemClickListenerForLike: ((Post) -> Unit)? = null
...
//
//
//            var onItemClickListenerForGoingtoOwner: ((Post) -> Unit)? = null
//
...
//                onItemClickListenerForGoingtoOwner?.let { it(event) }
//            }
//            val onItemClickListener: ((Post) -> Unit)? = null
