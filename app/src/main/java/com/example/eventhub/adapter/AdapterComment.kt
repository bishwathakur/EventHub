...
class AdapterComment  (
    ...
    override fun onBindViewHolder(holder: CommentViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            glide.load(curComment.userImage).error(R.drawable.default_user).into(itemCommentAvatarTv)
    ...
    private fun Context.createCommentDeletionDialog(onDelete: () -> Unit): AlertDialog {
        ...
        return builder.setTitle("Delete")
            ...
            .create().apply {
                setOnShowListener {
                    getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(this@createCommentDeletionDialog.getColorCompat(R.color.rred))
